...
public class ForecastFragment extends Fragment {
    ...
    // instantiates an ArrayAdapter<Strings> called ForecastAdapter, which gets called further down below
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) { // onCreateView creates and returns the view hierarchy associated with the fragment
        ...
        // (calls) populates that ForecastAdapter instantiated above with that List of Strings called weekForecast that's full of our dummy data right now
